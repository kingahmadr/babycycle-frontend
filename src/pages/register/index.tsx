...
export default function Register() {
  ...
  return (
    <div className='w-full bg-babyBlue max-md:bg-transparent flex justify-center'>

      <div className='max-w-[1440px] h-[calc(100vh-160px)] max-md:h-[calc(100vh-340px)] bg-[url(/Group_119.png)] max-md:bg-[url(/Hero2.png)] bg-no-repeat bg-center max-md:bg-left object-contain w-full flex items-center justify-center'>
